...
- 🎯 **Mission**: Build amazing digital products that are not only fast, but also secure.
- 💻 I specialize in crafting powerful web apps using **React**, **Node.js**, **Express**, and **PostgreSQL**.
- 🛡️ Deeply passionate about **Cyber Security** – I enjoy CTFs, penetration testing, and bug bounty hunting.
- 🚧 Currently working on: **Cardiorisk Predictor**, a web-based health-tech app using AI + Fullstack.
- 🌱 On a journey to master **Web App Security**, **Cloud Security**, and **DevSecOps**.
- ✨ Fun fact: I blend **design**, **functionality**, and **security** into everything I build.
...
#### 🛡️ Security Tools
![Burp Suite](https://img.shields.io/badge/-Burp%20Suite-FC4C02?logo=burp-suite&logoColor=white&style=for-the-badge)
![OWASP ZAP](https://img.shields.io/badge/-OWASP%20ZAP-2D2D2D?logo=owasp&logoColor=white&style=for-the-badge)
...
const profile = {
  name: "Muh Diaz",
  stack: ["React", "Node.js", "PostgreSQL", "Cyber Security"],
